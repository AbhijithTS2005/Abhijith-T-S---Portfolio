...
const MOON_ICON = `${ASSET_BASE}/moon_icon.11395d36.png`;
const OBJECT_3D = `${ASSET_BASE}/p59_1.4659672e.png`;
const LEGO_ICON = `${ASSET_BASE}/lego_icon-1.703bb594.png`;
const GROUP_3D = `${ASSET_BASE}/Group_134-1.2e04f3ce.png`;
